...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-center font-weight-bolder mb-4">Add Category Form</h4>
                    ...
                    <form action="{{ route('category.new') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="description" id="horizontal-email-input" cols="" rows="6"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
